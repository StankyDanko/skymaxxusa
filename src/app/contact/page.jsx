      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <a
                ...
                className="flex items-center gap-4 p-4 bg-[#1e293b] rounded-xl border border-white/10 hover:border-white/20 transition-all group"
              >
                ...
                <div>
                  ...
                  <p className="font-bold text-white group-hover:text-[#DC2626] transition-colors">
                    {CONTACT_PHONE}
                  </p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 p-4 bg-[#1e293b] rounded-xl border border-white/10">
                <div className="w-10 h-10 bg-[#DC2626] rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-[#1e293b] rounded-xl border border-white/10 p-5">
              <h3 className="font-black text-white mb-3">Business Hours</h3>
          ...
          <div>
            ...
            <div className="contact-form-card bg-[#1e293b] rounded-2xl shadow-xl border-2 border-[#DC2626]/20 p-7 md:p-9">
              {status === "success" ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className="w-full px-4 py-3 bg-[#0f172a] border border-white/10 rounded-xl text-sm text-white placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-[#DC2626]/30 focus:border-[#DC2626] transition-colors resize-none"
                        required
                      />
                    </div>
